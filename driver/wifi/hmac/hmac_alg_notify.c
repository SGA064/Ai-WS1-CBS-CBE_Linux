...
/*****************************************************************************
 函 数 名  : hmac_alg_register_get_intf_info_notify
 功能描述  : 注册干扰信息获取
*****************************************************************************/
osal_u32 hmac_alg_register_get_intf_info_notify(p_alg_get_intf_info_func func)
{
    g_hmac_algorithm_main->get_intf_info_func = func;

    return OAL_SUCC;
}

/*****************************************************************************
 函 数 名  : hmac_alg_unregister_get_intf_info_notify
 功能描述  : 去注册干扰信息获取
*****************************************************************************/
osal_u32 hmac_alg_unregister_get_intf_info_notify(osal_void)
{
    g_hmac_algorithm_main->get_intf_info_func = OSAL_NULL;

    return OAL_SUCC;
}

/*****************************************************************************
 函 数 名  : hmac_alg_get_intf_info
 功能描述  : 干扰信息获取
*****************************************************************************/
osal_u32 hmac_alg_get_intf_info(hal_alg_intf_det_mode_enum_uint8 *adjch_intf_type,
    oal_bool_enum_uint8 *coch_intf_type, osal_s8 *intf_det_avg_rssi_20)
{
    if (osal_unlikely(g_hmac_algorithm_main->get_intf_info_func == OSAL_NULL)) {
        return OAL_ERR_CODE_PTR_NULL;
    }

    g_hmac_algorithm_main->get_intf_info_func(adjch_intf_type, coch_intf_type, intf_det_avg_rssi_20);
