...
typedef enum {
    ...
    WLAN_UTIL_NOTIFIER_EVENT_DEL_USER_COMPLETE,
    ...
    WLAN_UTIL_NOTIFIER_EVENT_RX_BEACON,
    WLAN_UTIL_NOTIFIER_EVENT_USER_RATE_RX_INFO,
    WLAN_UTIL_NOTIFIER_EVENT_STAT_THROUGHPUT,
    WLAN_UTIL_NOTIFIER_EVENT_CHANNEL_SCORE,
