...
typedef enum {
    ...
    WLAN_CFG_PRIV_CPU_FREQ_LEVEL,
    WLAN_CFG_PRIV_TEMP_PROTECT_LEVEL,
    WLAN_CFG_PRIV_BUTT,
} wlan_cfg_priv;
...
#ifdef _PRE_WLAN_NO_SUPPORT_INI
extern osal_void hwifi_config_refresh_rf_fe_tx_power(osal_void);
extern osal_void hwifi_config_init_rf_fe_tx_power(osal_void);
#endif
...
#endif
extern osal_u8 hwifi_get_cpu_freq_level(osal_void);
extern osal_void hwifi_set_cpu_freq_level(osal_u8);
