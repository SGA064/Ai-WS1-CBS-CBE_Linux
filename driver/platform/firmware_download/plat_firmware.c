...
osal_s32 firmware_dev_crash_read_mem(osal_u8 *key, osal_u8 *value)
{
    ...
    do {
        ...
        puc_data_buf = (osal_u8 *)osal_kmalloc(sdio_transfer_limit, (OSAL_GFP_KERNEL | OSAL_GFP_NOWARN));
...
static osal_void firmware_buf_init(hcc_bus *pst_bus)
{
    ...
    g_fw_data_buf = (osal_u8 *)osal_kmalloc(MAX_FIRMWARE_FILE_TX_BUF_LEN, OSAL_GFP_KERNEL | OSAL_GFP_NOWARN);
