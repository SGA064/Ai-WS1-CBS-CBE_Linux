...
public class NearlinkAdapter {
     ...
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_PAIR_REMOVED = "android.nearlink.adapter.action.PAIR_REMOVED";
    ...
    @IntDef(prefix = {"ANNOUNCE_"}, value = {
        ANNOUNCE_MODE_NONE, ANNOUNCE_MODE_CONNECTABLE, ANNOUNCE_MODE_CONNECTABLE_DISCOVERABLE
    })
    ...
    /**
     * Extra used by {@link #ACTION_PAIR_REMOVED}
     * <p>
     * This extra represents whether the pair removed success or not.
     * Attention PAIR_REMOVE_FAILED will be returnd if the device has been unpaired.
     * Possible values are:
     * {@link #PAIR_REMOVE_SUCC},
     * {@link #PAIR_REMOVE_FAILED}
     */
    public static final String EXTRA_PAIR_REMOVE_STATUS = "android.nearlink.adapter.extra.PAIR_REMOVE_STATUS";
     ...
     * 移除配对成功
     */
    public static final int PAIR_REMOVE_SUCC = 0;
    
    /**
     * 移除配对失败
     */
    public static final int PAIR_REMOVE_FAILED = 1;
     ...
     */
    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    public static final String ACTION_REQUEST_ENABLE = "android.nearlink.adapter.action.REQUEST_ENABLE";
     ...
     */
    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    public static final String ACTION_REQUEST_DISABLE = "android.nearlink.adapter.action.REQUEST_DISABLE";
     ...
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_LOCAL_NAME_CHANGED = "android.nearlink.adapter.action.LOCAL_NAME_CHANGED";
     ...
     */
    @SystemApi
    public static final String ACTION_NEARLINK_STATE_CHANGED = "android.nearlink.adapter.action.NEARLINK_STATE_CHANGED";
     ...
     * @hide
     */
    public static final String EXTRA_NEARLINK_ADDRESS = "android.nearlink.adapter.extra.NEARLINK_ADDRESS";
    ...
    public NearlinkDevice getRemoteDevice(byte[] address) {
        ...
        return new NearlinkDevice(
            String.format(Locale.US, "%02X:%02X:%02X:%02X:%02X:%02X", address[0], address[1], address[2], address[3],
                address[4], address[5]));
    }
    ...
    /**
     * 同时启动Nearlink的扫描和广播，启动成功后，android系统广播ACTION_DISCOVERY_STARTED
     * 扫描到的设备结果以android系统广播ACTION_FOUND
     *
    ...
    public boolean startDiscovery() {
        ...
        try {
            ...
            return iNearlinkDiscovery.startDiscovery(nearlinkSeekParams, nearlinkAnnounceParam, nearlinkAnnounceData,
                nearlinkSeekRespData);
        } catch (RemoteException e) {
            Log.e(TAG, "", e);
        } finally {
            mServiceLock.readLock().unlock();
     ...
     */
    public boolean getProfileProxy(Context context, NearlinkProfile.ServiceListener listener, int profile) {
    ...
    private final INearlinkManagerCallback mManagerCallback = new INearlinkManagerCallback.Stub() {
