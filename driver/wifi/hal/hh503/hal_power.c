...
osal_void hal_power_set_pow_tpc_level_table(osal_u8 pow_level, osal_u8 band, osal_s8 tpc_offset)
{
    if (band >= WLAN_BAND_BUTT || pow_level >= HAL_POW_LEVEL_NUM) {
        return;
    }
    g_pow_tpc_level_table[pow_level][band] = tpc_offset;
}
