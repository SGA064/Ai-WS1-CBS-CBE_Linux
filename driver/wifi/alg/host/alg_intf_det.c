...
OSAL_STATIC osal_void alg_intf_det_get_intf_info(hal_alg_intf_det_mode_enum_uint8 *adjch_intf_type,
...
#ifdef _PRE_WLAN_INFO_REPORT
    hmac_alg_register_get_intf_info_notify(alg_intf_det_get_intf_info);
#endif
#ifdef _PRE_WLAN_SUPPORT_CCPRIV_CMD
...
#ifdef _PRE_WLAN_INFO_REPORT
    hmac_alg_unregister_get_intf_info_notify();
#endif
#ifdef _PRE_WLAN_SUPPORT_CCPRIV_CMD
    ...
    oal_bool_enum_uint8 *coch_intf_type, osal_s8 *intf_det_avg_rssi_20)
{
    ...
    ret = hmac_alg_get_device_priv_stru(hal_device, HAL_ALG_DEVICE_STRU_ID_INTF_DET, (osal_void **)&intf_det);
    if (osal_unlikely(ret != OAL_SUCC)) {
        oam_error_log0(0, OAM_SF_ANTI_INTF, "{alg_intf_det_get_intf_info: get intf det struct fail!}");
        return;
    }
    *adjch_intf_type = intf_det->adjch_intf_info.intf_type;
    *coch_intf_type = intf_det->coch_intf_info.coch_intf_state_sta;
    *intf_det_avg_rssi_20 = intf_det->adjch_intf_stat.intf_det_avg_rssi_20;
}
#endif
#endif
