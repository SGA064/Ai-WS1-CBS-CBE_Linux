...
#if defined(_PRE_WLAN_FEATURE_NOTICE_LOG) && defined(_PRE_PRODUCT_ID_HOST)
#define WIFI_LOG "[notice]"
/* debug level log wapper macro */
#define oam_notice_log0(_uc_vap_0, _en_feature_0, fmt) \
    do {                                                \
        osal_printk(WIFI_LOG fmt"\r\n");                  \
    } while (0)
#define oam_notice_log1(_uc_vap_0, _en_feature_0, fmt, p1) \
    do {                                                    \
        osal_printk(WIFI_LOG fmt"\r\n", (td_u32)(p1));        \
    } while (0)
#define oam_notice_log2(_uc_vap_0, _en_feature_0, fmt, p1, p2)    \
    do {                                                           \
        osal_printk(WIFI_LOG fmt"\r\n", (td_u32)(p1), (td_u32)(p2)); \
    } while (0)
#define oam_notice_log3(_uc_vap_0, _en_feature_0, fmt, p1, p2, p3)              \
    do {                                                                         \
        osal_printk(WIFI_LOG fmt"\r\n", (td_u32)(p1), (td_u32)(p2), (td_u32)(p3)); \
    } while (0)
#define oam_notice_log4(_uc_vap_0, _en_feature_0, fmt, p1, p2, p3, p4)                        \
    do {                                                                                       \
...
#define oam_notice_log0(_uc_vap_0, _en_feature_0, fmt) \
    do {                                              \
        ext_diag_notice_log0(0, fmt);                  \
    } while (0)
#define oam_notice_log1(_uc_vap_0, _en_feature_0, fmt, p1) \
    do {                                                  \
        ext_diag_notice_log1(0, fmt, (td_u32)(p1));        \
    } while (0)
#define oam_notice_log2(_uc_vap_0, _en_feature_0, fmt, p1, p2)    \
    do {                                                         \
        ext_diag_notice_log2(0, fmt, (td_u32)(p1), (td_u32)(p2)); \
    } while (0)
#define oam_notice_log3(_uc_vap_0, _en_feature_0, fmt, p1, p2, p3)              \
    do {                                                                       \
        ext_diag_notice_log3(0, fmt, (td_u32)(p1), (td_u32)(p2), (td_u32)(p3)); \
    } while (0)
#define oam_notice_log4(_uc_vap_0, _en_feature_0, fmt, p1, p2, p3, p4)                        \
    do {                                                                                     \
        ext_diag_notice_log4(0, fmt, (td_u32)(p1), (td_u32)(p2), (td_u32)(p3), (td_u32)(p4)); \
    } while (0)
...
/* notice level log wapper macro */
#define oam_notice_log0(_uc_vap_0, _en_feature_0, fmt)
#define oam_notice_log1(_uc_vap_0, _en_feature_0, fmt, p1) \
    do {                                                    \
        (void)(p1);                                         \
        oam_notice_log0(_uc_vap_0, _en_feature_0, fmt);    \
    } while (0)
#define oam_notice_log2(_uc_vap_0, _en_feature_0, fmt, p1, p2) \
    do {                                                        \
        (void)(p2);                                             \
        oam_notice_log1(_uc_vap_0, _en_feature_0, fmt, p1);    \
    } while (0)
#define oam_notice_log3(_uc_vap_0, _en_feature_0, fmt, p1, p2, p3) \
    do {                                                            \
        (void)(p3);                                                 \
        oam_notice_log2(_uc_vap_0, _en_feature_0, fmt, p1, p2);    \
    } while (0)
#define oam_notice_log4(_uc_vap_0, _en_feature_0, fmt, p1, p2, p3, p4) \
    do {                                                                \
        (void)(p4);                                                     \
        oam_notice_log3(_uc_vap_0, _en_feature_0, fmt, p1, p2, p3);    \
    } while (0)
...
#define oam_notice_log_alter(_uc_vap_0, _en_feature_0, fmt, num, args...)
...
#define oam_notice_buf(_uc_vap_0, _en_feature_0, buffer, data_size, fmt, type) \
    ext_diag_warning_log_buff(0, buffer, data_size, fmt, type)
...
#define oam_notice_log0(_uc_vap_0, _en_feature_0, fmt)    do { \
        debug_message("WARN0 id=%d, line=%d\r\n", THIS_FILE_ID, __LINE__); \
    } while (0)
#define oam_notice_log1(_uc_vap_0, _en_feature_0, fmt, p1)    do { \
        debug_message("WARN1 id=%d, line=%d\r\n", THIS_FILE_ID, __LINE__); \
    } while (0)
#define oam_notice_log2(_uc_vap_0, _en_feature_0, fmt, p1, p2)    do { \
        debug_message("WARN2 id=%d, line=%d\r\n", THIS_FILE_ID, __LINE__); \
    } while (0)
#define oam_notice_log3(_uc_vap_0, _en_feature_0, fmt, p1, p2, p3)    do { \
        debug_message("WARN3 id=%d, line=%d\r\n", THIS_FILE_ID, __LINE__); \
    } while (0)
#define oam_notice_log4(_uc_vap_0, _en_feature_0, fmt, p1, p2, p3, p4)    do { \
        debug_message("WARN4 id=%d, line=%d\r\n", THIS_FILE_ID, __LINE__); \
    } while (0)
...
#define oam_notice_log_alter(id, feature_id, fmt, num, arg...)
