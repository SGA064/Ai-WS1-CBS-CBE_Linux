...
#define CONN_PARAM_INITIATOR_FILTER_POLICY 0
#define CONN_PARAM_INITIATE_PHYS 1
#define CONN_PARAM_NEGOTIATE 0x1
#define CONN_PARAM_SCAN_INT 0xA0
#define CONN_PARAM_SCAN_WIN 0xA0
#define CONN_PARAM_CONNECTION_INT_MAX 0x64
#define CONN_PARAM_CONNECTION_INT_MIN 0x64
#define CONN_PARAM_SUPERVISION_TIMEOUT 0x1FC
...
static void nearlink_change_default_connect_param()
{
    sle_default_connect_param_t default_param = {
        .enable_filter_policy = CONN_PARAM_INITIATOR_FILTER_POLICY,
        .initiate_phys = CONN_PARAM_INITIATE_PHYS,
        .gt_negotiate = CONN_PARAM_NEGOTIATE,
        .scan_interval = CONN_PARAM_SCAN_INT,
        .scan_window = CONN_PARAM_SCAN_WIN,
        .min_interval = CONN_PARAM_CONNECTION_INT_MAX,
        .max_interval = CONN_PARAM_CONNECTION_INT_MIN,
        .timeout = CONN_PARAM_SUPERVISION_TIMEOUT,
    };
    errcode_t ret = sle_default_connection_param_set(&default_param);
    ALOGI("adapter_sle_enable_callback set default connection param status: 0x%x\n", ret);
}
...
void nearlink_adapter_enable_callback(errcode_t status)
{
    ...
    nearlink_change_default_connect_param();
