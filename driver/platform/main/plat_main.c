...
#if defined(CONFIG_HCC_SUPPORT_SDIO) && (CONFIG_HCC_SUPPORT_SDIO != 0)
    channel_init.bus_type = HCC_BUS_SDIO;
#elif defined(CONFIG_HCC_SUPPORT_USB) && (CONFIG_HCC_SUPPORT_USB != 0)
    channel_init.bus_type = HCC_BUS_USB;
#elif defined(CONFIG_HCC_SUPPORT_UART) && (CONFIG_HCC_SUPPORT_UART != 0)
    channel_init.bus_type = HCC_BUS_UART;
#else
#error "No HCC bus type selected!"
#endif
