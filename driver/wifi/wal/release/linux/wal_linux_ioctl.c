...
osal_u32 hwifi_force_refresh_rf_params(oal_net_device_stru *net_dev)
{
    ...
    hwifi_config_refresh_rf_fe_tx_power();
#else
...
/*****************************************************************************
 功能描述  : 根据国家码设置管制域
*****************************************************************************/
osal_u32  wal_setcountry(oal_net_device_stru *net_dev, osal_s8 *para)
{
...
*****************************************************************************/
OAL_STATIC osal_void hwifi_config_init_ini_country(oal_net_device_stru *cfg_net_dev)
{
    osal_s32 l_ret;
