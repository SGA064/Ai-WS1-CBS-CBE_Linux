...
{
    u_bypass_sample_control bypass_sample_control;
    bypass_sample_control.u32 = hal_reg_read(HH503_MAC_CTRL0_BANK_BASE_0x138);

    if (enable == OSAL_TRUE) {
        bypass_sample_control.bits.x6NgwhGqwjtuGCCwWh_ = 1;
        bypass_sample_control.bits.xCt2OGwlOZ3IOCCzOyQGzssOmo_ = 1;
        bypass_sample_control.bits.x6NgwCW6wVySw66GwjtuGCCwWh_ = 1;
    } else {
        bypass_sample_control.bits.x6NgwhGqwjtuGCCwWh_ = 0;
        bypass_sample_control.bits.xCt2OGwlOZ3IOCCzOyQGzssOmo_ = 0;
        bypass_sample_control.bits.x6NgwCW6wVySw66GwjtuGCCwWh_ = 0;
    }
    hal_reg_write(HH503_MAC_CTRL0_BANK_BASE_0x138, bypass_sample_control.u32);
}
