...
#define OSAL_GFP_NOWARN __GFP_NOWARN
#define osal_kmalloc kmalloc
#define osal_kzalloc kzalloc
...
/*
 * osal_kzalloc() - This API is used to allocate a memory block of which the size is specified
                    and the data is set to zeros.
