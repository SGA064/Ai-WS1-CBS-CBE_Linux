...
static unsigned int osal_convert_gfp_flag(unsigned int osal_gfp_flag)
{
    ...
    if ((osal_gfp_flag & OSAL_GFP_KERNEL) != 0) {
        gfp_flag |= GFP_KERNEL;
    }
    if ((osal_gfp_flag & OSAL_GFP_ATOMIC) != 0) {
        gfp_flag |= GFP_ATOMIC;
    }
    if ((osal_gfp_flag & OSAL_GFP_DMA) != 0) {
        gfp_flag |= GFP_DMA;
    }
    if ((osal_gfp_flag & OSAL_GFP_ZERO) != 0) {
        gfp_flag |= __GFP_ZERO;
    }
    if ((osal_gfp_flag & OSAL_GFP_NOWARN) != 0) {
