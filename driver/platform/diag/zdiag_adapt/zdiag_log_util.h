...
#define ext_diag_notice_log0(id, fmt) \
        zdiag_log_print0_press_prv(ext_diag_log_msg_mk_id_n(id), ext_diag_log_msg_mk_mod_id(0))
#define ext_diag_notice_log1(id, fmt, p1) \
        zdiag_log_print1_press_prv(ext_diag_log_msg_mk_id_n(id), ext_diag_log_msg_mk_mod_id(0), p1)
#define ext_diag_notice_log2(id, fmt, p1, p2) \
        zdiag_log_print2_press_prv(ext_diag_log_msg_mk_id_n(id), ext_diag_log_msg_mk_mod_id(0), p1, p2)
#define ext_diag_notice_log3(id, fmt, p1, p2, p3) \
    do { \
        zdiag_log_msg3 log_msg = {p1, p2, p3}; \
        zdiag_log_print3_press_prv(ext_diag_log_msg_mk_id_n(id), ext_diag_log_msg_mk_mod_id(0), &log_msg); \
    } while (0)
#define ext_diag_notice_log4(id, fmt, p1, p2, p3, p4) \
    do { \
        zdiag_log_msg4 log_msg = {p1, p2, p3, p4}; \
        zdiag_log_print4_press_prv(ext_diag_log_msg_mk_id_n(id), ext_diag_log_msg_mk_mod_id(0), &log_msg); \
    } while (0)
