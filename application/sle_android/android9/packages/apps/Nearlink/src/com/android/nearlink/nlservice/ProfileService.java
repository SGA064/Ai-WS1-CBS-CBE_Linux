...
public abstract class ProfileService extends Service {
    ...
    protected NearlinkDevice getDevice(byte[] address, int type) {
        if (mAdapter == null) {
            return null;
        }
        return mAdapter.getRemoteDevice(
                new NearlinkAddress(Utils.getAddressStringFromByte(address), type));
    }
}
