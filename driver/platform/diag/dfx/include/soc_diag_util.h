...
#define ext_diag_log_msg_mk_id_w(id) ((((((td_u32)(ext_check_default_id(id))) << 4) & 0x3FFF0) + DIAG_LOG_LEVEL_WARN) \
    + ((((td_u32)(THIS_FILE_ID)) & 0x3FFF) << 18))
#define ext_diag_log_msg_mk_id_n(id) ((((((td_u32)(ext_check_default_id(id))) << 4) & 0x3FFF0) + \
    DIAG_LOG_LEVEL_NOTICE) + ((((td_u32)(THIS_FILE_ID)) & 0x3FFF) << 18))
...
#define ext_diag_notice_log0(id, fmt) \
    {                                                                                                        \
        _PRIM_ST, _PRIM_PRI_ = DIAG_LOG_LEVEL_NOTICE, _PRIM_ID_ = id, _PRIM_SZ_ = fmt, _PRIM_LINE_ = __LINE__, \
        _PRIM_FILE_ = __FILE_NAME__, _PRIM_FILE_ID_ = __FILE_IDX__, _PRIM_TYPE_ = diag_log_msg0, _PRIM_END_  \
    }
#define ext_diag_notice_log1(id, fmt, p0) \
    {                                                                                                        \
        _PRIM_ST, _PRIM_PRI_ = DIAG_LOG_LEVEL_NOTICE, _PRIM_ID_ = id, _PRIM_SZ_ = fmt, _PRIM_LINE_ = __LINE__, \
        _PRIM_FILE_ = __FILE_NAME__, _PRIM_FILE_ID_ = __FILE_IDX__, _PRIM_TYPE_ = diag_log_msg1, _PRIM_END_  \
    }
#define ext_diag_notice_log2(id, fmt, p0, p1) \
    {                                                                                                        \
        _PRIM_ST, _PRIM_PRI_ = DIAG_LOG_LEVEL_NOTICE, _PRIM_ID_ = id, _PRIM_SZ_ = fmt, _PRIM_LINE_ = __LINE__, \
        _PRIM_FILE_ = __FILE_NAME__, _PRIM_FILE_ID_ = __FILE_IDX__, _PRIM_TYPE_ = diag_log_msg2, _PRIM_END_  \
    }
#define ext_diag_notice_log3(id, fmt, p0, p1, p2) \
    {                                                                                                        \
        _PRIM_ST, _PRIM_PRI_ = DIAG_LOG_LEVEL_NOTICE, _PRIM_ID_ = id, _PRIM_SZ_ = fmt, _PRIM_LINE_ = __LINE__, \
        _PRIM_FILE_ = __FILE_NAME__, _PRIM_FILE_ID_ = __FILE_IDX__, _PRIM_TYPE_ = diag_log_msg3, _PRIM_END_  \
    }
#define ext_diag_notice_log4(id, fmt, p0, p1, p2, p3) \
    {                                                                                                        \
        _PRIM_ST, _PRIM_PRI_ = DIAG_LOG_LEVEL_NOTICE, _PRIM_ID_ = id, _PRIM_SZ_ = fmt, _PRIM_LINE_ = __LINE__, \
        _PRIM_FILE_ = __FILE_NAME__, _PRIM_FILE_ID_ = __FILE_IDX__, _PRIM_TYPE_ = diag_log_msg4, _PRIM_END_  \
    }
#define ext_diag_notice_log_buff(id, log_info, data_size, fmt, type) \
    {                                                                                                        \
        _PRIM_ST, _PRIM_PRI_ = DIAG_LOG_LEVEL_NOTICE, _PRIM_ID_ = id, _PRIM_SZ_ = fmt, _PRIM_LINE_ = __LINE__, \
        _PRIM_FILE_ = __FILE_NAME__, _PRIM_FILE_ID_ = __FILE_IDX__, _PRIM_TYPE_ = type, _PRIM_END_           \
    }
...
#define ext_diag_notice_log0(id, fmt) \
    diag_log_msg0_prv(ext_diag_log_msg_mk_id_n(id), ext_diag_log_msg_mk_mod_id(0), 0)
#define ext_diag_notice_log1(id, fmt, p1) \
    diag_log_msg1_prv(ext_diag_log_msg_mk_id_n(id), ext_diag_log_msg_mk_mod_id(0), 0, p1)
#define ext_diag_notice_log2(id, fmt, p1, p2) \
    diag_log_msg2_prv(ext_diag_log_msg_mk_id_n(id), ext_diag_log_msg_mk_mod_id(0), 0, p1, p2)
#define ext_diag_notice_log3(id, fmt, p1, p2, p3) \
do { \
    diag_log_msg3 log_msg = {p1, p2, p3}; \
    diag_log_msg3_prv(ext_diag_log_msg_mk_id_n(id), ext_diag_log_msg_mk_mod_id(0), 0, log_msg); \
} while (0)
#define ext_diag_notice_log4(id, fmt, p1, p2, p3, p4) \
do { \
    diag_log_msg4 log_msg = {p1, p2, p3, p4}; \
    diag_log_msg4_prv(ext_diag_log_msg_mk_id_n(id), ext_diag_log_msg_mk_mod_id(0), 0, log_msg); \
} while (0)
#define ext_diag_notice_log_buff(id, log_info, data_size, fmt, type) \
    diag_log_msg_buffer_prv(ext_diag_log_msg_mk_id_n(id), ext_diag_log_msg_mk_mod_id(0), 0, log_info, data_size)
...
#define ext_diag_notice_log0(id, fmt) \
    oam_log_print0_press_prv(ext_diag_log_msg_mk_id_n(id), ext_diag_log_msg_mk_mod_id(0))
#define ext_diag_notice_log1(id, fmt, p1) \
    oam_log_print1_press_prv(ext_diag_log_msg_mk_id_n(id), ext_diag_log_msg_mk_mod_id(0), p1)
#define ext_diag_notice_log2(id, fmt, p1, p2) \
    oam_log_print2_press_prv(ext_diag_log_msg_mk_id_n(id), ext_diag_log_msg_mk_mod_id(0), p1, p2)
#define ext_diag_notice_log3(id, fmt, p1, p2, p3) \
do { \
    zdiag_log_msg3 log_msg = {p1, p2, p3}; \
    oam_log_print3_press_prv(ext_diag_log_msg_mk_id_n(id), ext_diag_log_msg_mk_mod_id(0), &log_msg); \
} while (0)
#define ext_diag_notice_log4(id, fmt, p1, p2, p3, p4) \
do { \
    zdiag_log_msg4 log_msg = {p1, p2, p3, p4}; \
    oam_log_print4_press_prv(ext_diag_log_msg_mk_id_n(id), ext_diag_log_msg_mk_mod_id(0), &log_msg); \
} while (0)
#define ext_diag_notice_log_buff(id, log_info, data_size, fmt, type) \
    oam_log_print_buff_press_prv(ext_diag_log_msg_mk_id_n(id), ext_diag_log_msg_mk_mod_id(0), log_info, data_size)
...
#define ext_diag_notice_log0(id, fmt) diag_io_print("[NOTICE]"fmt"\r\n")
#define ext_diag_notice_log1(id, fmt, p1) diag_io_print("[NOTICE]"fmt" %d\r\n", p1)
#define ext_diag_notice_log2(id, fmt, p1, p2) diag_io_print("[NOTICE]"fmt" %d %d\r\n", p1, p2)
#define ext_diag_notice_log3(id, fmt, p1, p2, p3) diag_io_print("[NOTICE]"fmt" %d %d %d\r\n", p1, p2, p3)
#define ext_diag_notice_log4(id, fmt, p1, p2, p3, p4) diag_io_print("[NOTICE]"fmt" %d %d %d %d\r\n", p1, p2, p3, p4)
#define ext_diag_notice_log_buff(id, log_info, data_size, fmt, type)
